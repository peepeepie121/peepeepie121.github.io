...
<html prefix="og: http://ogp.me/ns#" lang="en-GB" dir="ltr">
	<head>
		<title>Home Page  - The Golden Arch</title>
		<meta charset="utf-8" />
		...
		<meta property="og:url" content="http://peepeepie121.github.io/home-page-.php" />
		...
		<link rel="stylesheet" href="pcss/home-page-.css?2021-5-7-0-638468109203348066" media="screen,print" />
		...
		x5engine.boot.push(function () { x5engine.contentSlider['imObjectContentSlider_13_16'].autoplay(7000); }, false, 8); 
		
		</script>
		<script>
			window.onload = function(){ checkBrowserCompatibility('Your browser does not support the features necessary to display this website.','Your browser may not support the features necessary to display this website.','[1]Update your browser[/1] or [2]continue without updating[/2].','http://outdatedbrowser.com/'); };
			x5engine.utils.currentPagePath = 'home-page-.php';
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden">Home Page  - The Golden Arch</h1>
...
$(function () {$('#imStickyBar_imMenuObject_02_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_02_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_02_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
					...
					<main id="imContent" class="imFullHeightRows imAutoScrollingRows">
						<a id="imGoToCont"></a>
						<header>
							<h2 id="imPgTitle">Home Page </h2>
						</header>
						<div id="imPageRow_1" class="imPageRow">
						
						</div>
						<div id="imCell_16" class=""  data-responsive-sequence-number="1"> <div id="imCellStyleGraphics_16"></div><div id="imCellStyleBorders_16"></div><div id="imObjectContentSlider_13_16" class="content-slider content-slider-root"><div class="content-slider content-slider-container change-effect-fade"><div id="imObjectContentSlider_13_16-slide-0" class="content-slider slide-container default-slide"><div class="content-slider slide-grid-container full-grid image-top element-effect-none"><div class="content-slider slide-element slide-animated-element slide-image-container"><img class="content-slider slide-image-content slide-animated-content" src="images/Ghanian-male-model-suppied-by-Microsoft.png"></div><div class="content-slider slide-element slide-txt-container"><div class="content-slider slide-txt-content"><div class="content-slider slide-animated-element slide-txt-block-container slide-title"><div class="content-slider slide-txt-block-content slide-animated-content slide-title" >Ghanian style: The lifestyle side </div></div><div class="content-slider slide-animated-element slide-txt-block-container slide-description"><div class="content-slider slide-txt-block-content slide-animated-content slide-description" >In this story, we found interesting cocpet revolving around how a speciicway forward i </div></div></div></div></div></div><div id="imObjectContentSlider_13_16-slide-1" class="content-slider slide-container slide-container-link" onclick="x5engine.utils.location('our-stories.html', null, false); return false;"><div class="content-slider slide-grid-container full-grid image-top element-effect-none"><div class="content-slider slide-element slide-animated-element slide-image-container"><img class="content-slider slide-image-content slide-animated-content" src="images/RNEGEADES-BOTSWANA-SUBCULTURE---PROVIDED-MICROSOFT-AI.png"></div><div class="content-slider slide-element slide-txt-container"><div class="content-slider slide-txt-content"><div class="content-slider slide-animated-element slide-txt-block-container slide-title"><div class="content-slider slide-txt-block-content slide-animated-content slide-title" >Botswana Culture: the essence of living "Rock Spectrums" beyond </div></div><div class="content-slider slide-animated-element slide-txt-block-container slide-description"><div class="content-slider slide-txt-block-content slide-animated-content slide-description" >This is the newest findings in subculture aspects: a rythmic scope beyond the heightened sense of living... Read more... </div></div></div></div></div></div><div id="imObjectContentSlider_13_16-slide-2" class="content-slider slide-container"><div class="content-slider slide-grid-container full-grid image-top element-effect-none"><div class="content-slider slide-element slide-animated-element slide-image-container"><img class="content-slider slide-image-content slide-animated-content" src="images/PERCHANCE---AI-CREATED-IMAGE.jpg"></div><div class="content-slider slide-element slide-txt-container"><div class="content-slider slide-txt-content"><div class="content-slider slide-animated-element slide-txt-block-container slide-title"><div class="content-slider slide-txt-block-content slide-animated-content slide-title" >Ghanian Style - a new autencitc look beyond </div></div><div class="content-slider slide-animated-element slide-txt-block-container slide-description"><div class="content-slider slide-txt-block-content slide-animated-content slide-description" >The fashion world looks at these extensions of expression through the lens of male models in Ghanian - check out our new week story that finds how men in Ghana are changing the revolutions online - Image supplied by Purchance (AI) image generator </div></div></div></div></div></div><div id="imObjectContentSlider_13_16-slide-3" class="content-slider slide-container"><div class="content-slider slide-grid-container full-grid image-top element-effect-none"><div class="content-slider slide-element slide-animated-element slide-image-container"><img class="content-slider slide-image-content slide-animated-content" src="images/Perchane-Image---indigenous-man-concept-of-clothes.jpg"></div><div class="content-slider slide-element slide-txt-container"><div class="content-slider slide-txt-content"><div class="content-slider slide-animated-element slide-txt-block-container slide-title"><div class="content-slider slide-txt-block-content slide-animated-content slide-title" >Indigenous power - a new horizon </div></div><div class="content-slider slide-animated-element slide-txt-block-container slide-description"><div class="content-slider slide-txt-block-content slide-animated-content slide-description" >In the Native Spaces, in Arizone, lay netsled, a new way forward, a new focus to life has emerged. These men share cultural heritage through their views and how the life, and lifestyle chocies in the maginficient part of the US, is a far and unique reach beyond. Image supplied by Purchance (AI) image generator </div></div></div></div></div></div><div id="imObjectContentSlider_13_16-slide-4" class="content-slider slide-container"><div class="content-slider slide-grid-container full-grid image-top element-effect-none"><div class="content-slider slide-element slide-animated-element slide-image-container"><img class="content-slider slide-image-content slide-animated-content" src="images/BRAZIL-CULTURE--.jpg"></div><div class="content-slider slide-element slide-txt-container"><div class="content-slider slide-txt-content"><div class="content-slider slide-animated-element slide-txt-block-container slide-title"><div class="content-slider slide-txt-block-content slide-animated-content slide-title" >Brazilian culture: The party ops  </div></div><div class="content-slider slide-animated-element slide-txt-block-container slide-description"><div class="content-slider slide-txt-block-content slide-animated-content slide-description" >Brazilian Culture parties - this is about fashion, style and a new venture into the Amazonian Forest, an adventure, beyond. Here a group of men share an interest of defining party culture; in a shared and unique setting ,where music and life of the party, are but a shared experience. </div></div></div></div></div></div><div class="content-slider content-slider-ctrl-container ctrl-visible"><div class="content-slider content-slider-ctrl btn-ctrl btn-prev ctrl-visible" onclick ="x5engine.contentSlider['imObjectContentSlider_13_16'].prev();"><svg class="arrow-btn left-arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><rect class="a" x="5" y="5" width="40" height="40" rx="12" ry="12"/><path class="b" d="M31.62,34,18.09,25l13.53-9v-1.3l-14.8,9.85a.54.54,0,0,0,0,.9l14.8,9.86Z"/></svg></div><div class="content-slider content-slider-ctrl btn-ctrl btn-next ctrl-visible" onclick ="x5engine.contentSlider['imObjectContentSlider_13_16'].next();"><svg class="arrow-btn right-arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><rect class="a" x="5" y="5" width="40" height="40" rx="12" ry="12"/><path class="b" d="M18.38,16l13.53,9L18.38,34v1.3l14.8-9.85a.54.54,0,0,0,0-.9l-14.8-9.86Z"/></svg></div><div class="content-slider current-slide-radio-visible-container"><div class="content-slider content-slider-ctrl current-slide-radio-container ctrl-visible"><label for="imObjectContentSlider_13_16-slide-radio-0" class="content-slider current-slide-radio imObjectContentSlider_13_16-slide-radio-0"><input class="content-slider current-slide-radio-hidden" type ="radio" name="imObjectContentSlider_13_16_current_slide" value="0" id = "imObjectContentSlider_13_16-slide-radio-0" onclick = "x5engine.contentSlider['imObjectContentSlider_13_16'].goTo(0);" checked><div class="content-slider current-slide-radio-visible"></div></label><label for="imObjectContentSlider_13_16-slide-radio-1" class="content-slider current-slide-radio imObjectContentSlider_13_16-slide-radio-1"><input class="content-slider current-slide-radio-hidden" type ="radio" name="imObjectContentSlider_13_16_current_slide" value="1" id = "imObjectContentSlider_13_16-slide-radio-1" onclick = "x5engine.contentSlider['imObjectContentSlider_13_16'].goTo(1);"><div class="content-slider current-slide-radio-visible"></div></label><label for="imObjectContentSlider_13_16-slide-radio-2" class="content-slider current-slide-radio imObjectContentSlider_13_16-slide-radio-2"><input class="content-slider current-slide-radio-hidden" type ="radio" name="imObjectContentSlider_13_16_current_slide" value="2" id = "imObjectContentSlider_13_16-slide-radio-2" onclick = "x5engine.contentSlider['imObjectContentSlider_13_16'].goTo(2);"><div class="content-slider current-slide-radio-visible"></div></label><label for="imObjectContentSlider_13_16-slide-radio-3" class="content-slider current-slide-radio imObjectContentSlider_13_16-slide-radio-3"><input class="content-slider current-slide-radio-hidden" type ="radio" name="imObjectContentSlider_13_16_current_slide" value="3" id = "imObjectContentSlider_13_16-slide-radio-3" onclick = "x5engine.contentSlider['imObjectContentSlider_13_16'].goTo(3);"><div class="content-slider current-slide-radio-visible"></div></label><label for="imObjectContentSlider_13_16-slide-radio-4" class="content-slider current-slide-radio imObjectContentSlider_13_16-slide-radio-4"><input class="content-slider current-slide-radio-hidden" type ="radio" name="imObjectContentSlider_13_16_current_slide" value="4" id = "imObjectContentSlider_13_16-slide-radio-4" onclick = "x5engine.contentSlider['imObjectContentSlider_13_16'].goTo(4);"><div class="content-slider current-slide-radio-visible"></div></label></div></div></div></div></div></div><div id="imCell_3" class=""  data-responsive-sequence-number="2"> <div id="imCellStyleGraphics_3"></div><div id="imCellStyleBorders_3"></div><div id="imTextObject_13_03">
